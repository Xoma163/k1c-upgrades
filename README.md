...
faulty_region_1_max: 5,220
# Top dead zone: avoid probing in the whole top strip above Y=210
faulty_region_2_min: 0,210
faulty_region_2_max: 220,220
# Brush zone: avoid probing around the nozzle cleaning brush
faulty_region_3_min: 85,205
faulty_region_3_max: 165,225
```
